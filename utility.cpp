//This file contains the important functions structures and classes which will be used in source code files
//Pass1 and Pass2
#include<iostream>
#include<fstream>
#include<string>
...
//to convert an integer to an hexadecimal string
